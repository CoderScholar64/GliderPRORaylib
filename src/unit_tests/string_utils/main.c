...
int main() {
    ...
    // One character test
    {
        // Random text generated by me.
        Str255 paragraphs = "I like computers.";

        Str255 answer = "I\n\nl\ni\nk\ne\n\nc\no\nm\np\nu\nt\ne\nr\ns\n.";

        WrapText(paragraphs, 1);
    ...
    // One character test overflow test
    {
        // Random text generated by me.
        Str255 paragraphs;

        memset(paragraphs, 'B', sizeof(paragraphs) / sizeof(paragraphs[0]));
        ...
        answer[sizeof(answer) / sizeof(answer[0]) - 1] = '\0';
    ...
    // Smaller test
    {
        ...
        Str255 answer = "I like computers.";

        WrapText(paragraphs, 28);
    ...
    {
        // Random text generated by me.
        Str255 paragraphs = "I like computer programming.";

        Str255 answer = "I like computer programming.";
    ...
    // Large test
    {
        ...
        Str255 answer = "I like computer\nprogramming.";

        WrapText(paragraphs, 27);
    ...
    {
        // Random text generated by me.
        Str255 paragraphs = "I like computer programming. I can solve math problems as well.";

        Str255 answer = "I like\ncomputer\nprogramming.\nI can solve\nmath problems\nas well.";

        WrapText(paragraphs, 14);
